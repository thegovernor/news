...
import type { PrivacyPolicyContent } from "@/lib/sanity/queries"
      ...
      return (
        <div className="my-8">
          <Image
            ...
            alt={value.alt || "Privacy policy image"}
            width={1200}
            height={800}
...
export function PrivacyPolicyContent({ privacyPolicy }: PrivacyPolicyContentProps) {
  return (
    <div className="w-full">
      ...
      {privacyPolicy.mainImage && (
        <section className="relative w-full h-[50vh] min-h-[400px] md:h-[60vh] overflow-hidden">
          <Image
            src={urlFor(privacyPolicy.mainImage).width(1920).height(1080).url()}
      ...
      <div className="container mx-auto px-4 max-w-4xl py-8 md:py-12">
        ...
        {privacyPolicy.lastUpdated && (
          <div className="flex items-center gap-2 text-sm text-muted-foreground mb-8 pb-4 border-b">
            ...
            <span>
              آخر تحديث:{" "}
              {new Date(privacyPolicy.lastUpdated).toLocaleDateString("ar-SA", {
                year: "numeric",
                month: "long",
                day: "numeric",
              })}
