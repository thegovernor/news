...
export function PoliticalAnalysisArticlesList({ articles }: PoliticalAnalysisArticlesListProps) {
  return (
    <>
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4 max-w-7xl h-full flex items-center justify-center relative z-10">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto">
              تحليلات شاملة ومتعمقة للأحداث السياسية المحلية والإقليمية والدولية
            </p>
          </div>
        </div>
      </section>
