...
interface PoliticalAnalysisArticleDetailProps {
...
export function PoliticalAnalysisArticleDetail({ article }: PoliticalAnalysisArticleDetailProps) {
  return (
      ...
      <div className="container mx-auto px-4 max-w-4xl py-8 md:py-12">
        ...
        <div className="mt-12 pt-8 border-t">
          ...
          >
            ...
            العودة إلى قائمة التحليلات السياسية
          </Link>
        </div>
      </div>
    </article>
